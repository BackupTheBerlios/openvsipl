...
void build_kernel(Binary_expr<L, R, expr::op::Add> e, Kernel<T>& k)
{
...
template <typename L, typename R, typename T>
void build_kernel(Binary_expr<L, R, expr::op::Sub> e, Kernel<T>& k)
{
  Kernel_builder<L, T>::apply(e.left(), k);
  Kernel<T> k2(k);
...
void build_kernel(Binary_expr<Binary_expr<L, R, O>, S, expr::op::Mult> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
...
template <typename S, 
          ...
          typename T>
void build_kernel(Binary_expr<S, Binary_expr<L, R, O>, expr::op::Mult> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
...
template <typename L, typename R, template <typename, typename> class O,
          typename S, typename T>
void build_kernel(Binary_expr<Binary_expr<L, R, O>, S, expr::op::Div> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
  Kernel_builder<Binary_expr<L, R, O>, T>::apply(e.left(), k1);
...
template <typename V, typename I, typename J,
          typename S, typename T>
void build_kernel(Binary_expr<Call<V, I, J>, S, expr::op::Mult> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
...
template <typename S, 
          ...
          typename T>
void build_kernel(Binary_expr<S, Call<V, I, J>, expr::op::Mult> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
...
template <typename V, typename I, typename J,
          typename S, typename T>
void build_kernel(Binary_expr<Call<V, I, J>, S, expr::op::Div> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
  Kernel_builder<Call<V, I, J>, T>::apply(e.left(), k1);
