...
template <typename L, typename R, template <typename, typename> class O,
          typename S>
class Binary_expr<Binary_expr<L, R, O>, S, expr::op::Mult>
{
public:
...
template <typename L, typename R, template <typename, typename> class O,
          typename S>
class Binary_expr<Binary_expr<L, R, O>, S, expr::op::Div>
{
public:
  typedef typename Binary_expr<L, R, O>::view_type view_type;
...
class Binary_expr<S, Binary_expr<L, R, O>, expr::op::Mult>
{
public:
  typedef typename Binary_expr<L, R, O>::view_type view_type;
...
class Binary_expr<Call<V, I, J>, S, expr::op::Mult>
{
public:
  typedef V view_type;
...
template <typename V, typename I, typename J, typename S>
class Binary_expr<Call<V, I, J>, S, expr::op::Div>
{
public:
  typedef V view_type;
...
class Binary_expr<S, Call<V, I, J>, expr::op::Mult>
{
public:
  typedef V view_type;
...
typename vsip::impl::Type_if<Binary_expr<L, R, expr::op::Add>, 
                             Is_expr<L>::value || Is_expr<R>::value>::type
operator+ (L l, R r)
{
  return Binary_expr<L, R, expr::op::Add>(l, r);
}

template <typename L, typename R>
typename vsip::impl::Type_if<Binary_expr<L, R, expr::op::Sub>,
                             Is_expr<L>::value || Is_expr<R>::value>::type
operator- (L l, R r)
{
  return Binary_expr<L, R, expr::op::Sub>(l, r);
}

template <typename L, typename R>
typename vsip::impl::Type_if<Binary_expr<L, R, expr::op::Mult>,
                             Is_expr<L>::value || Is_expr<R>::value>::type
operator* (L l, R r)
{
  return Binary_expr<L, R, expr::op::Mult>(l, r);
}

template <typename L, typename R>
typename vsip::impl::Type_if<Binary_expr<L, R, expr::op::Div>,
                             Is_expr<L>::value || Is_expr<R>::value>::type
operator/ (L l, R r)
{
  return Binary_expr<L, R, expr::op::Div>(l, r);
}
