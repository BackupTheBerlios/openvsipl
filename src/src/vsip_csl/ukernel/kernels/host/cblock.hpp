...
/** @file    vsip_csl/ukernel/kernels/host/cblock.hpp
...
#ifndef VSIP_CSL_UKERNEL_KERNELS_HOST_CBLOCK_HPP
#define VSIP_CSL_UKERNEL_KERNELS_HOST_CBLOCK_HPP
...
#include <vsip_csl/ukernel/kernels/params/cblock_param.hpp>
...
class Cblock : public Host_kernel
{
  // Parameters.
...
DEFINE_UKERNEL_TASK(vsip_csl::ukernel::Cblock, void(), "uk_plugin", cblock_f)
