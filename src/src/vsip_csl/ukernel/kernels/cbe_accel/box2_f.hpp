...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/box2_f.hpp
    @author  Jules Bergmann
    @date    2008-01-23
    @brief   VSIPL++ Library: 2D Box filter UKernel.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_BOX2_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_BOX2_F_HPP
