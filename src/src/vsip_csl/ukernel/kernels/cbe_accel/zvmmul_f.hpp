...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/zvmmul_f.hpp
    @author  Jules Bergmann
    @date    2008-08-20
    @brief   VSIPL++ Library: Split-complex vector-matrix multiply UKernel.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_ZVMMUL_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_ZVMMUL_F_HPP
