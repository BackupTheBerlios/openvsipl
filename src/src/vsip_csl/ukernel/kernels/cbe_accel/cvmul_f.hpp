...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/cvmul_f.hpp
    @author  Jules Bergmann
    @date    2008-06-12
    @brief   VSIPL++ Library: UKernel to compute inter-complex vmul.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_CVMUL_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_CVMUL_F_HPP
