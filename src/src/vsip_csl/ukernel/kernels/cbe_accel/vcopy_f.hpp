...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/vcopy_f.hpp
    @author  Jules Bergmann
    @date    2008-06-10
    @brief   VSIPL++ Library: Ukernel to perform vector copy.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_VCOPY_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_VCOPY_F_HPP
