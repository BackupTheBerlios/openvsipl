...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/fused_kernel.hpp
    @author  Jules Bergmann
    @date    2008-06-24
    @brief   VSIPL++ Library: Fused ukernel.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_FUSED_KERNEL_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_FUSED_KERNEL_HPP
