...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/id2_f.hpp
    @author  Jules Bergmann
    @date    2008-07-29
    @brief   VSIPL++ Library: Kernel to ID2.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_ID2_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_ID2_F_HPP
