...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/zvmul_f.hpp
    @author  Jules Bergmann
    @date    2008-06-12
    @brief   VSIPL++ Library: UKernel to compute split-complex vmul.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_ZVMUL_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_ZVMUL_F_HPP
