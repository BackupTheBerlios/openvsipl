...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/cmadd_f.hpp
    @author  Don McCoy
    @date    2008-08-26
    @brief   VSIPL++ Library: User-defined kernel for multiply-add.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_CMADD_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_CMADD_F_HPP
