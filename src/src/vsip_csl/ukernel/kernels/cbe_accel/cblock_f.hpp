...
*/
/** @file    vsip_csl/ukernel/kernels/cbe_accel/cblock_f.hpp
    @author  Jules Bergmann
    @date    2008-12-12
    @brief   VSIPL++ Library: User-defined kernel example illustrating
                              a control-block approach.
*/
#ifndef VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_CBLOCK_F_HPP
#define VSIP_CSL_UKERNEL_KERNELS_CBE_ACCEL_CBLOCK_F_HPP
...
#define DUMP_STACK(TEXT)                                                \
  {                                                                     \
    ...
    printf("STACK(%s): cur %05x  pre %05x  ra %05x\n", TEXT,            \
