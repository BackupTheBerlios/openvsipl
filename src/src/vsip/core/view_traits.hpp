...
/// Trait that provides typedef 'type' iff VIEW is a valid lazy view.
template <typename> struct Is_lazy_view_type
{ static bool const value = false;};
...
template <> struct Dim_of_view<lazy_Vector>
  { static const dimension_type dim = 1; };

template <> struct Dim_of_view<lazy_Matrix>
  { static const dimension_type dim = 2; };

template <> struct Dim_of_view<lazy_Tensor> 
  { static const dimension_type dim = 3; };
...
template <typename Block> struct lazy_of_view<vsip::Vector, Block>
{ typedef lazy_Vector<typename Block::value_type, Block> type;};

template <typename Block> struct lazy_of_view<vsip::const_Vector, Block>
{ typedef lazy_Vector<typename Block::value_type, Block> type;};

template <typename Block> struct lazy_of_view<vsip::Matrix, Block>
{ typedef lazy_Matrix<typename Block::value_type, Block> type;};

template <typename Block> struct lazy_of_view<vsip::const_Matrix, Block>
{ typedef lazy_Matrix<typename Block::value_type, Block> type;};

template <typename Block> struct lazy_of_view<vsip::Tensor,Block> 
{ typedef lazy_Tensor<typename Block::value_type, Block> type;};

template <typename Block> struct lazy_of_view<vsip::const_Tensor,Block> 
{ typedef lazy_Tensor<typename Block::value_type, Block> type;};
