...
public:
  ...
  template <typename T0, typename Block0>
  Vector &operator=(impl::lazy_Vector<T0, Block0> const &v) VSIP_NOTHROW
  {
    assert(this->size() == v.size());
    impl::assign<1>(this->block(), v.block());
    return *this;
...
template <typename T, typename Block>
class lazy_Vector : public const_Vector<T, Block>
{
public:
  lazy_Vector(Block &b) VSIP_NOTHROW : const_Vector<T, Block>(b) {}
  // lazy copy: don't evaluate.
  lazy_Vector(lazy_Vector const &v) : const_Vector<T, Block>(v.block()) {}
};
...
{
  typedef impl::lazy_Vector<T, Block> lazy_view_type;
...
template <typename T, typename Block>
struct ViewConversion<impl::lazy_Vector, T, Block>
{
  typedef impl::lazy_Vector<T, Block> lazy_view_type;
  typedef const_Vector<T, Block> const_view_type;
  typedef Vector<T, Block> view_type;
...
template <typename T, typename Block> 
struct Is_view_type<impl::lazy_Vector<T, Block> >
{
  typedef impl::lazy_Vector<T, Block> type;
  static bool const value = true;
};
