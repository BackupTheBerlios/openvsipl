...
template <typename Block0,
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_mm, be::generic, 
...
template <typename Block0,
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_mm_conj, be::generic,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  static bool const ct_valid = true;
  static bool rt_valid(Block0&, Block1 const&, Block2 const&)
...
template <typename Block0,
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_mv, be::generic,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  static bool const ct_valid = true;
  static bool rt_valid(Block0&, Block1 const&, Block2 const&)
...
template <typename Block0,
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_vm, be::generic,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  static bool const ct_valid = true;
  static bool rt_valid(Block0&, Block1 const&, Block2 const&)
