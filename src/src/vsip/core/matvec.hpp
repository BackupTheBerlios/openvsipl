...
#ifndef VSIP_IMPL_REF_IMPL
template<>
struct List<op::prod_vv_outer>
{
  typedef Make_type_list<be::cml,
			 be::blas,
			 be::mercury_sal,
			 be::cvsip,
...
template <typename T1,
	  ...
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_vv_outer, be::generic,
...
template <typename T,
	  typename Block0,
	  typename Block1>
struct Evaluator<op::prod_vv_dot, be::generic,
...
template <typename T1,
	  ...
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_gemp, be::generic,
  ...
  Matrix<T2, Block2>       r)
{
  ...
  Evaluator<op::prod_vv_outer, be::cvsip, 
    void(Block2&, T0, Block0 const&, Block1 const&)>::exec
    (r.block(), alpha, a.block(), b.block());
#else
  vsip_csl::dispatch<op::prod_vv_outer, void,
...
#ifdef VSIP_IMPL_REF_IMPL
  r = Evaluator<op::prod_vv_dot, be::cvsip,
    return_type(Block0 const&, Block1 const&) >::exec
    (v.block(), w.block());
#else
  r = vsip_csl::dispatch<op::prod_vv_dot, return_type,
