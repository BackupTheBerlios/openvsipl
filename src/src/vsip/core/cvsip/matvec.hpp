...
template <typename T,
          typename Block0,
          typename Block1>
struct Evaluator<op::prod_vv_dot, be::cvsip,
                 T(Block0 const&, Block1 const&)>
{
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_vv_dot/cvsip", exec);
				 ...
				 expr::Unary<expr::op::Conj, Block1, true> const&)>
{
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_vv_dot(conj)/cvsip", exec);
    assert(a.size(1, 0) == b.size(1, 0));
...
template <typename T,
          ...
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_vv_outer, be::cvsip,
                 void(Block0&, T, Block1 const&, Block2 const&)>
{
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_vv_outer/cvsip", exec);
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_vm, be::cvsip,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_vm/cvsip", exec);
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mv, be::cvsip, 
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_mv/cvsip", exec);
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mm, be::cvsip,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
  typedef impl::cvsip::Op_traits<T> traits;
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_mm/cvsip", exec);
...
template <typename T,
          ...
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_gemp, be::cvsip,
                 void(Block0&, T, Block1 const&, Block2 const&, T)>
{
  ...
  {
    VSIP_IMPL_COVER_FCN("op::prod_gemp/cvsip", exec);
    impl::Ext_data<Block0> ext_c(c);
    impl::Ext_data<Block1> ext_a(a);
    impl::Ext_data<Block2> ext_b(b);
