...
template <typename T1,
          ...
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_vv_outer, be::mercury_sal,
...
template <typename T,
          typename Block0,
          typename Block1>
struct Evaluator<op::prod_vv_dot, be::mercury_sal,
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mv, be::mercury_sal,
...
template <typename Block0,
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_vm, be::mercury_sal,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
...
template <typename Block0,
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_mm, be::mercury_sal,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
...
template <typename T1,
	  ...
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_gemp, be::mercury_sal,
