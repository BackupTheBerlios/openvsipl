...
template <typename T1,
	  ...
	  typename Block1,
	  typename Block2>
struct Evaluator<op::prod_vv_outer, be::blas,
...
template <typename T,
          typename Block0,
          typename Block1>
struct Evaluator<op::prod_vv_dot, be::blas,
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mv, be::blas,
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_vm, be::blas,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mm, be::blas,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
...
template <typename T1,
	  ...
	  typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_gemp, be::blas,
