...
template <typename T,
          typename Block0,
          typename Block1>
struct Evaluator<op::prod_vv_dot, be::cml,
                 T(Block0 const&, Block1 const&)>
{
  ...
  static T exec(Block0 const& a, Block1 const& b)
  {
    ...
    T r = T();
    impl::cml::dot(ext_a.data(), ext_a.stride(0),
				 ...
				 expr::Unary<expr::op::Conj, Block1, true> const&)>
{
			 ...
			 expr::Unary<expr::op::Conj, Block1, true> const& b)
  {
    ...
    impl::cml::dotc(ext_a.data(), ext_a.stride(0),
		    ext_b.data(), ext_b.stride(0),
		    &r, a.size(1, 0));
    return r;
  }
...
template <typename T1,
          ...
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_vv_outer, be::cml,
                 void(Block0&, T1, Block1 const&, Block2 const&)>
{
  ...
  static bool const ct_valid = 
    ...
    impl::Type_equal<order0_type, row2_type>::value &&
    // check that all data types are equal
    impl::Type_equal<T1, typename Block0::value_type>::value &&
                 ...
                 void(Block0&, std::complex<T1>, Block1 const&, Block2 const&)>
{
  ...
  static bool const ct_valid = 
    ...
    impl::Type_equal<order0_type, row2_type>::value &&
    // check that all data types are equal
    impl::Type_equal<std::complex<T1>, typename Block0::value_type>::value &&
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mv, be::cml,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  ...
  static void exec(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    {
      impl::cml::mvprod(ext_a.data(), ext_a.stride(0),
			ext_b.data(), ext_b.stride(0),
			ext_r.data(), ext_r.stride(0),
			a.size(2, 0),  // M
			a.size(2, 1)); // N
    ...
    {
      impl::cml::vmprod(ext_b.data(), ext_b.stride(0),
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_vm, be::cml,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
  ...
  static void exec(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    {
      impl::cml::vmprod(ext_a.data(), ext_a.stride(0),
			ext_b.data(), ext_b.stride(0),
			ext_r.data(), ext_r.stride(0),
			b.size(2, 0),  // M
			b.size(2, 1)); // N
    ...
    {
      impl::cml::mvprod(ext_b.data(), ext_b.stride(1),
			ext_a.data(), ext_a.stride(0),
			ext_r.data(), ext_r.stride(0),
			b.size(2, 1),  // N
			b.size(2, 0)); // M
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mm, be::cml,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
  typedef typename impl::Block_layout<Block0>::order_type order0_type;
  ...
  static bool const ct_valid = 
    ...
    impl::Type_equal<order0_type, row2_type>::value && 
    impl::Type_equal<order1_type, row2_type>::value && 
    // check that direct access is supported
    impl::Ext_data_cost<Block0>::value == 0 &&
    impl::Ext_data_cost<Block1>::value == 0 &&
    impl::Ext_data_cost<Block2>::value == 0;
  ...
  static void exec(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    if (impl::Type_equal<order2_type, row2_type>::value)
    {
      impl::cml::mprod(ext_a.data(), ext_a.stride(0),
		       ext_b.data(), ext_b.stride(0),
		       ext_r.data(), ext_r.stride(0),
		       a.size(2, 0),  // M
		       a.size(2, 1),  // N
    ...
    {
      impl::cml::mprodt(ext_a.data(), ext_a.stride(0),
...
template <typename Block0,
          typename Block1,
          typename Block2>
struct Evaluator<op::prod_mm_conj, be::cml,
                 void(Block0&, Block1 const&, Block2 const&)>
{
  typedef typename Block0::value_type T;
  typedef typename impl::Block_layout<Block0>::order_type order0_type;
  ...
  static void exec(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    if (impl::Type_equal<order2_type, row2_type>::value)
    {
      impl::cml::mprodj(ext_a.data(), ext_a.stride(0),
			ext_b.data(), ext_b.stride(0),
			ext_r.data(), ext_r.stride(0),
			a.size(2, 0),  // M
			a.size(2, 1),  // N
    ...
    {
      impl::cml::mprodh(ext_a.data(), ext_a.stride(0),
			ext_b.data(), ext_b.stride(1),
			ext_r.data(), ext_r.stride(0),
			a.size(2, 0),  // M
			a.size(2, 1),  // N
