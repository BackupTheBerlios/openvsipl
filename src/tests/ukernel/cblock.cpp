...
#include <vsip_csl/ukernel/kernels/host/cblock.hpp>
...
{
  Ext_data<typename View0::block_type> ext0(in0.block());
  Ext_data<typename View1::block_type> ext1(in1.block());
  Ext_data<typename View2::block_type> ext2(in2.block());
  Ext_data<typename View3::block_type> ext3(out.block());
