...
main(int argc, char **argv)
{
  ...
  typedef vsip::impl::cuda::Gpu_block<2, T>  gpu_block_type;
  ...
  fftmul_test<T, gpu_block_type>(128, 256);
  fftmul_test<T, gpu_block_type>(357, 1253);
  fftmul_test<T, gpu_block_type>(1024, 2048);
